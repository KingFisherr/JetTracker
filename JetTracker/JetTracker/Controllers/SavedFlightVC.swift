...
class SavedFlightVC: UIViewController{
    var tableView = UITableView()
    var savedJobsArray: [String] = []
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        title = "Saved Flights"
        if let myArray = UserDefaults.standard.array(forKey: "SavedFlight") as? [String] {
            // Modify the array by appending the new element
            savedJobsArray = myArray
        }
...
extension SavedFlightVC: UITableViewDelegate, UITableViewDataSource{
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        // Count of data in array
        return savedJobsArray.count
    }
